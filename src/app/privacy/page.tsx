    ...
    <>
      <div className="pt-4 px-6 pb-24 md:pb-6">
        ...
        <div>
          ...
          <ol className="list-decimal list-inside ml-4">
            <li>Email address;</li>
            <li>Image associated with gmail account; and</li>
            <li>Name associated with gmail account.</li>
          </ol>
          <p className="text-left">
            This data may be collected using the following methods:
          </p>
          <ol className="list-decimal list-inside ml-4">
            <li>Signing Up and Commenting/Liking blog posts.</li>
          </ol>
          <br />
        </div>
        ...
        <div>
          ...
          <ol className="list-decimal list-inside ml-4">
            ...
            <li>Improve websites functionality.</li>
          </ol>
          <br />
        </div>
        ...
        <div>
          <p className="text-left">
            ...
            please contact us with the methods disclosed above.
            <br />
            <br />
          </p>
        </div>
        ...
        <div>
          <p className="text-left">
            ...
            please contact us through the contact methods listed above, so that
            we can, where possible, resolve the issue. If you feel we have not
            ...
            complaint to a supervisory authority. You can lodge a complaint with
            a supervisory authority by contacting the Data Protection
            Commission.
          </p>
        </div>
      </div>
